...
- <Pls /> can render high-quality [SVG icons](/features/svg.mdx) from icon packs
  like [Catppuccin](https://github.com/catppuccin/vscode-icons) for files and
  directories. eza cannot do this.
