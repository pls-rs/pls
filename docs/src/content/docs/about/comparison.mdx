...
- <Pls /> creates a grid of uniform width for each cell, which looks more spaced
  out, whereas eza's grid view is more compact by compressing each column into
  as small a width as necessary.
