---
title: FAQ
description: The arrival of a new alternative to ls(1) is bound to raise questions. Here
...
No. <Pls /> is an alternative, not a replacement, for `ls(1)`. It has some more
