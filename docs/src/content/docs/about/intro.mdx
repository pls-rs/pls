...
You can refer to [our comparison](/pls/about/comparison/) of <Pls /> to other
`ls(1)` alternatives, notably exa.

## More info

For more information, take a look at the [FAQs](/pls/about/faq/). If your
question isn't answered there, feel free to start a
[GitHub discussion](https://github.com/dhruvkb/pls/discussions).
