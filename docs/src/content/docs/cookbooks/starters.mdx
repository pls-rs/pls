...
description: The USP of pls is that it uses plaintext YAML configurations that can be
...
If you build Python projects using Pipenv, Poetry, PDM or uv, this config is for
you.
