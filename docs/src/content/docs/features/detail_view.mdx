---
title: Detail view
description: pls can show a lot of metadata about each file in a tabular layout when the
...
This field can be styled by specifying `entry_const.perm_styles`. <Pls /> allows
