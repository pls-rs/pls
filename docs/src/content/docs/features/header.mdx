---
title: Header
description: pls shows helpful headers for columns in the detail view and enables users to
...
This flag has no effect unless the [detail view](/features/detail_view/) is
enabled with `--det`/`-d`.
