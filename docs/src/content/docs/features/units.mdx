---
title: Units
description: pls can show the sizes of files in three unit systems, binary (powers of 2),
...
- binary, which uses higher powers of 2 such as 2<sup>10</sup> as kibi (Ki),
  2<sup>20</sup> as mebi (Mi) etc.
- decimal, which uses higher powers of 10 such as 10<sup>3</sup> as kilo (k),
