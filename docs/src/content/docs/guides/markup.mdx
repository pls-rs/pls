...
<pre className="terminal">
  ...
  <span style="color:var(--blue,#00a)"> only blue text</span>
  <b> only bold text</b>
</pre>
...
<pre className="terminal">
  <span style="color:var(--blue,#00a)">blue text</span>
</pre>
...
<pre className="terminal">
  <span style="color:var(--bright-red,#f55)">orange text</span>{" "}
  <span style="color:var(--bright-magenta,#f5f)">violet text</span>
</pre>
...
<pre className="terminal">
  <span style="background:var(--blue,#00a)">
    <span style="color:var(--black,#000)">black text</span>{" "}
    <span style="color:var(--white,#fff)">white text</span>
  </span>
</pre>
