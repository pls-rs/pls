...
def test_finds_all_configs_in_ancestors(work_dirs: tuple[Path, Path, Path, Path]):
    workbench, one, two, three = work_dirs
...
def test_finds_config_upto_ancestor_depth(work_dirs: tuple[Path, Path, Path, Path]):
    workbench, one, two, three = work_dirs
...
def test_finds_config_in_git_root(work_dirs: tuple[Path, Path, Path, Path]):
    workbench, one, two, three = work_dirs
...
def test_finds_config_in_home_dir(work_dirs: tuple[Path, Path, Path, Path]):
    workbench, one, two, three = work_dirs
